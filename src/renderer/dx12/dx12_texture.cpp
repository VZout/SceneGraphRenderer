...
#include "../interface.h"
#include "d3d12_dds_texture_loader.h"
...
int LoadImageDataFromMemory(BYTE** data, uint8_t* buffer, unsigned int size, D3D12_RESOURCE_DESC& resourceDescription, int &bytesPerRow) {
	HRESULT hr;
