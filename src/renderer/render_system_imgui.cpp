...
namespace rlr {
	...
	void RenderSystem::ImGui_RenderMainMenuBarMenu() {
		if (ImGui::BeginMenu("Graphics")) {
			...
			ImGui::MenuItem("Hardware Details", NULL, &imgui_show_hardware_details);
			ImGui::MenuItem("Postprocessing Settings", NULL, &imgui_show_postprocessing_settings);
			ImGui::MenuItem("Scene Graph", NULL, &imgui_show_render_graph);

			ImGui::Separator();
			if (ImGui::Button("Hide All")) {
				imgui_show_profiler = false;
				imgui_show_light_properties = false;
				imgui_show_cam_properties = false;
				imgui_show_hardware_details = false;
				imgui_show_postprocessing_settings = false;
				imgui_show_render_graph = false;
			}
	...
	void RenderSystem::ImGui_RenderHardwareDetails(IMGUI_RENDER_FUNC_PARAMS) {
		if (ImGui::BeginDock("Hardware Details", &imgui_show_hardware_details)) {
